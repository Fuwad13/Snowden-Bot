...
class Weather(commands.Cog):
    ...
    @commands.command(aliases=["wt"], name = 'weather', brief = 'Get current weather information for a city or location', help  = "Get current weather status of a city or location!")
