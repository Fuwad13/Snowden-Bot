...
class Owner(commands.Cog):
	...
	async def _initdb(self, ctx):
		try :
			await self.bot.db.execute(""" CREATE TABLE IF NOT EXISTS battlefield ( p_id bigint PRIMARY KEY, created_at bigint NOT NULL,joinpos serial,balance bigint default 500,opt_status boolean default false, hp int default 100, sp int default 0, exp bigint default 100, equipments json default '{"armour" : null, "weapon" : null}', cooldowns json default '{"n_hourly" : 0,"n_daily" : 0,"n_weekly" : 0,"n_monthly" : 0,"n_work" : 0, "n_loot" : 0, "n_attack" : 0, "n_heal" : 0, "n_opt_in_toggle" : 0, "n_equip" : 0}', common json default '{}', rare json default '{}', legendary json default '{}', epic json default '{}', mythic json default '{}', stats json default '{}', voter boolean default false); """)
